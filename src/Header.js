...
const Header = () => {
    ...
    return (
        ...
        <div className="header parent">
            <img src="/images/Rectangle 1.svg" className="lll" alt="" />
            <img src="/images/Rectangle 2.svg" className="rrr" alt="" />

 
            <div className="child headerC">
                <div className="aSide">
                <div className="logo"><img src="/images/logo_9tales.png" alt="Logo" /></div>
